  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-[var(--muted-foreground)]">
        Seus agendamentos em um so lugar.
      </p>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-3">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <h3 className="font-medium">{appt.service.name}</h3>
                      ...
                      <p className="text-sm text-[var(--muted-foreground)]">
                        <Link href={`/businesses/${appt.service.business.id}`} className="hover:underline">
            ...
            {past.map((appt) => (
              <Card key={appt.id} className="opacity-75">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-[var(--muted-foreground)]">
                    {appt.service.business.name} - {formatDate(appt.startTime)}
                  </p>
                </CardContent>
              </Card>
            ))}
